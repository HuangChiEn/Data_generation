## Quite good simple torch trainer template!!
## I took it from:https://github.com/francescocastelli/torch-trainer/blob/master/torchtrainer/trainer.py
##  we can modify it into accelerator version ~
