...
#unet = SDMUNet2DModel.from_pretrained("/data/harry/Data_generation/diffusers-main/examples/VAESDM/LDM-sdm540-model/checkpoint-62000", subfolder="unet").to("cuda").to(torch.float16)
#vae = VQModel.from_pretrained("CompVis/ldm-super-resolution-4x-openimages", subfolder="vqvae").to("cuda").to(torch.float16)
#unet = SDMUNet2DModel.from_pretrained("/data/harry/Data_generation/diffusers-main/examples/VAESDM/VQLDM-sdm540-model/checkpoint-62000", subfolder="unet").to("cuda").to(torch.float16)
unet = SDMUNet2DModel.from_pretrained("/data/harry/Data_generation/diffusers-main/examples/VAESDM/attnsdm-model/checkpoint-22000", subfolder="unet").to("cuda").to(torch.float16)
...
#pipe = SDMLDMPipeline.from_pretrained( "/data/harry/Data_generation/diffusers-main/examples/VAESDM/VQLDM-sdm540-model", torch_dtype = torch.float16)
