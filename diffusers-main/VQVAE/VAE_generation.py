...
def main(use_fp16=True,data_dir='/data1/dataset/Cityscapes',batch_size=2,image_size=540, mask_emb="resize"):
    ...
    vae = VQSub.from_pretrained("/data/harry/Data_generation/diffusers-main/VQVAE/Segmap_VQ_model/13ep", subfolder="vqvae")
    ...
    dataset = cityscape_ds.load_data(
        data_dir,
    ...
    data = torch.utils.data.DataLoader(
        dataset,
        shuffle=False,
        collate_fn=cityscape_ds.collate_fn,
