...
from dataset.cityscape_ds import load_data
from diffusion_module.utils.Pipline import SDMPipeline
...
def log_validation(unet, noise_scheduler, args, accelerator, weight_dtype, epoch):
    logger.info("Running validation... ")

    pipeline = SDMPipeline(
        unet=unet,
...
def parse_args():
    ...
    parser.add_argument(
        "--train_data_dir",
        type=str,
        default="/data1/dataset/Cityscapes/",
        help=(
